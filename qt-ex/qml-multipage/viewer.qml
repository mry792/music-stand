        ...
        GroupBox {
            ...
            StackLayout {
                ...
                Column {
                    ...
                    Label { font.bold: true; text: qsTr("Title") } InfoField { text: doc.title }
                    Label { font.bold: true; text: qsTr("Author") } InfoField { text: doc.author }
                    Label { font.bold: true; text: qsTr("Subject") } InfoField { text: doc.subject }
                    Label { font.bold: true; text: qsTr("Keywords") } InfoField { text: doc.keywords }
                    Label { font.bold: true; text: qsTr("Producer") } InfoField { text: doc.producer }
                    Label { font.bold: true; text: qsTr("Creator") } InfoField { text: doc.creator }
                    Label { font.bold: true; text: qsTr("Creation Date") } InfoField {text : doc.creationDate }
                    Label { font.bold: true; text: qsTr("Modification Date") } InfoField {text : doc.modificationDate }
                }
                    ...
                    delegate: Item {
                        ...
                        Rectangle {
                            ...
                            PdfPageImage {
                                ...
                                width: landscape ?
                                    thumbnailsView.cellWidth - 6 :
                                    height * pointSize.width / pointSize.height
                                height: landscape ?
                                    width * pointSize.height / pointSize.width :
        ...
        RowLayout {
            ...
            ToolButton {
                action: Action {
                    ...
                    icon.source: checked ?
                        "qrc:/multipage/resources/sidebar-collapse-left.svg" :
                        "qrc:/multipage/resources/sidebar-expand-left.svg"
            ...
            Label {
                ...
                text: "page " + (currentPageSB.value) + " of " + doc.pageCount +
                      ...
                      " original " + implicitPointSize.width.toFixed(1) +
                      "x" + implicitPointSize.height.toFixed(1) + " pt"
